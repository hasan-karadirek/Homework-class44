...
function tellFortune(numKids, partnerNames, locations, jobTitles) {
  const fortuneText = `You will be a ${selectRandomly(
    jobTitles
...
function main() {
  ...
  const partnerNames = ['Hasan', 'Andrew', 'rob', 'ricardo', 'Anna'];

  const locations = ['Amsterdam', 'Berlin', 'Athens', 'Rome', 'Utrecht'];

  const jobTitles = ['developer', 'doctor', 'engineer', 'builder', 'Manager'];
